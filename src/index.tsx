            ...
            <div class="space-y-8">
              <div class="inline-block">
                <span class="bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold">
                  <i class="fas fa-brain mr-2"></i>Intelligence Artificielle × Santé
                </span>
              </div>
              ...
              <div class="flex flex-wrap gap-4">
                ...
                <a href="#offre" class="bg-white text-primary px-8 py-4 rounded-full border-2 border-primary hover:bg-primary hover:text-white transition-all font-semibold">
            ...
            <div class="relative">
              ...
              <div class="relative bg-white rounded-3xl shadow-2xl p-8 space-y-6">
                <div class="flex items-center space-x-4 p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    <div class="font-semibold text-gray-800">IA Générative</div>
                ...
                <div class="flex items-center space-x-4 p-4 bg-purple-50 rounded-xl">
                  ...
                  <div>
                    <div class="font-semibold text-gray-800">Secteur Santé</div>
                ...
                <div class="flex items-center space-x-4 p-4 bg-cyan-50 rounded-xl">
                  ...
                  <div>
                    <div class="font-semibold text-gray-800">Résultats Concrets</div>
                    <div class="text-sm text-gray-600">ROI mesurable, efficacité optimisée</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 class="text-2xl font-bold mb-4 text-gray-800">Formations</h3>
              ...
              <ul class="space-y-3 mb-6">
                <li class="flex items-start">
                  ...
                  <span class="text-gray-700">Initiation IA & Enjeux Santé</span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-primary mr-3 mt-1"></i>
                  <span class="text-gray-700">Perfectionnement métier</span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-primary mr-3 mt-1"></i>
                  <span class="text-gray-700">Formations sur mesure</span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-primary mr-3 mt-1"></i>
                  <span class="text-gray-700">Certifications possibles</span>
                </li>
              </ul>
              <a href="#contact" class="text-primary font-semibold inline-flex items-center group-hover:gap-3 transition-all">
                En savoir plus
                <i class="fas fa-arrow-right ml-2"></i>
              </a>
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  <h3 class="text-2xl font-bold text-gray-800">Directeur RH (DRH)</h3>
                  <p class="text-gray-600">Optimisation des processus RH</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
                  ...
                  <div>
                    <div class="font-semibold text-gray-800">Rédaction d'offres d'emploi</div>
                    <div class="text-sm text-gray-600">Génération automatique adaptée au secteur santé</div>
                  </div>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-robot text-primary mr-3 mt-1"></i>
                  <div>
                    <div class="font-semibold text-gray-800">Tri & analyse de CV</div>
                    <div class="text-sm text-gray-600">Présélection intelligente des candidatures</div>
                  </div>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-robot text-primary mr-3 mt-1"></i>
                  <div>
                    <div class="font-semibold text-gray-800">Formation & onboarding</div>
                    <div class="text-sm text-gray-600">Parcours personnalisés assistés par IA</div>
                  </div>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-robot text-primary mr-3 mt-1"></i>
                  <div>
                    <div class="font-semibold text-gray-800">Gestion des compétences</div>
                    <div class="text-sm text-gray-600">Cartographie et développement RH</div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Intelligence financière & reporting</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Vision stratégique & innovation</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Gestion opérationnelle optimisée</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Focus patient & qualité des soins</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all">
              <div class="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Accompagnement personnalisé</p>
                </div>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div class="text-center p-8">
              ...
              <h3 class="text-xl font-bold mb-4 text-gray-800">Déploiement Durable</h3>
              <p class="text-gray-600">
          ...
          <div class="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <div class="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div class="bg-gradient-to-br from-primary to-secondary p-8 rounded-xl">
                ...
                <a href="#contact" class="inline-flex items-center bg-white text-primary px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all">
            ...
            <form class="space-y-6" id="contactForm">
              <div class="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" name="nom" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Votre nom" />
                </div>
                <div>
                  <label class="block text-sm font-semibold text-gray-700 mb-2">Prénom *</label>
                  <input type="text" name="prenom" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Votre prénom" />
                </div>
              </div>

              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Email *</label>
                <input type="email" name="email" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="votre.email@example.com" />
              </div>

              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Téléphone</label>
                <input type="tel" name="telephone" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="06 12 34 56 78" />
              </div>

              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Organisation *</label>
                <input type="text" name="organisation" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Nom de votre établissement" />
              </div>

              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Type d'établissement *</label>
                <select name="type" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
              ...
              <div>
                ...
                <select name="fonction" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                  <option value="">Sélectionnez...</option>
              ...
              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Votre besoin *</label>
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="formation" class="w-5 h-5 text-primary rounded focus:ring-primary" />
                    <span class="text-sm">Formation</span>
                  </label>
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="coaching" class="w-5 h-5 text-primary rounded focus:ring-primary" />
                    <span class="text-sm">Coaching</span>
                  </label>
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="conseil" class="w-5 h-5 text-primary rounded focus:ring-primary" />
                    <span class="text-sm">Conseil</span>
                  </label>
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="audit" class="w-5 h-5 text-primary rounded focus:ring-primary" />
                    <span class="text-sm">Audit</span>
                  </label>
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="seminaire" class="w-5 h-5 text-primary rounded focus:ring-primary" />
                    <span class="text-sm">Séminaire</span>
                  </label>
                  <label class="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" name="besoins[]" value="autre" class="w-5 h-5 text-primary rounded focus:ring-primary" />
              ...
              <div>
                ...
                <textarea name="message" rows="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Décrivez-nous votre projet et vos objectifs..."></textarea>
              </div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-200">
              ...
              <div class="grid md:grid-cols-3 gap-6">
                <div class="text-center">
                  ...
                  <a href="mailto:contact@quube.fr" class="text-primary hover:underline">contact@quube.fr</a>
                </div>
                <div class="text-center">
                  <div class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <i class="fas fa-phone text-primary text-xl"></i>
                  </div>
                  <div class="font-semibold text-gray-800">Téléphone</div>
                ...
                <div class="text-center">
                  ...
                  <div class="font-semibold text-gray-800">Rendez-vous</div>
                  <a href="https://calendly.com/quube" target="_blank" class="text-primary hover:underline">Prendre RDV</a>
                </div>
              </div>
            </div>
          </div>
